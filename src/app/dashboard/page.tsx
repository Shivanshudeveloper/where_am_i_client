      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-900">Safety Check-In</h1>
              <p className="text-sm text-slate-600">Manage your emergency alerts</p>
            </div>
          </div>
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-3xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-6">
                ...
                {currentStep === 1 && (
                  <div className="space-y-4">
                    <div>
                      ...
                      <Textarea
                        id="message"
                        placeholder="Include your location, plans, expected return time, and any relevant details..."
                        value={message}
                    ...
                    <div>
                      ...
                      <div className="border-2 border-dashed border-slate-200 rounded-lg p-4 text-center hover:border-slate-300 transition-colors">
                        ...
                        <label htmlFor="file-upload" className="cursor-pointer">
                          <span className="text-sm text-blue-600 hover:text-blue-700 font-medium">Upload files</span>
                          <input
                            id="file-upload"
                            type="file"
                            multiple
                      ...
                      {files.length > 0 && (
                        <div className="mt-3 space-y-2">
                          {files.map(file => (
                            <div key={file.id} className="flex items-center justify-between p-2.5 bg-slate-50 rounded-lg">
                  ...
                  <div className="space-y-4">
                    <div className="space-y-3">
                      {recipients.map((recipient, index) => (
                        <Card key={recipient.id} className="p-4 bg-gradient-to-br from-white to-slate-50 border-slate-200 hover:border-slate-300 transition-colors">
                          <div className="space-y-3">
                            <div>
                              <Label htmlFor={`name-${recipient.id}`} className="text-sm mb-1.5 flex items-center gap-1.5 font-medium">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                              <div>
                                <Label htmlFor={`email-${recipient.id}`} className="text-sm mb-1.5 flex items-center gap-1.5 font-medium">
                              ...
                              <div>
                                <Label htmlFor={`phone-${recipient.id}`} className="text-sm mb-1.5 flex items-center gap-1.5 font-medium">
                ...
                {currentStep === 3 && (
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <Popover>
                          <PopoverTrigger asChild>
                            ...
                            >
                              ...
                              {deliveryDate ? format(deliveryDate, "PP") : "Select"}
                            </Button>
                          </PopoverTrigger>
                      ...
                      <div>
                        <Label htmlFor="time" className="font-medium mb-2 block text-sm">
                    ...
                    <div>
                      <Label htmlFor="timezone" className="font-medium mb-2 block text-sm">
                      ...
                      <p className="text-xs text-slate-500 mt-1.5">
                        Alert will be sent immediately if you don't check in by this deadline
                      </p>
                    </div>
                  </div>
                )}
                ...
                {currentStep === 4 && (
                  <div className="space-y-3">
                    <div className="border rounded-lg p-4 bg-gradient-to-br from-white to-slate-50">
                      <div className="flex items-start gap-3 mb-3 pb-3 border-b">
                        <div className="w-8 h-8 rounded-lg bg-blue-100 flex items-center justify-center flex-shrink-0">
                          <FileText className="w-4 h-4 text-blue-600" />
                        </div>
                        <div className="flex-1 min-w-0">
                          <h3 className="font-semibold text-sm text-slate-900 mb-1">Emergency Message</h3>
                      ...
                      <div className="flex items-start gap-3 mb-3 pb-3 border-b">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="font-semibold text-sm text-slate-900 mb-1">
                            Emergency Contacts ({recipients.filter(r => r.name && r.email).length})
                          </h3>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="font-semibold text-sm text-slate-900 mb-1">Check-in Deadline</h3>
          ...
          <Card className="border-dashed">
            <CardContent className="pt-12 pb-12">
              <div className="text-center max-w-md mx-auto">
                ...
                <h3 className="text-lg font-semibold text-slate-900 mb-2">No Active Check-Ins</h3>
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Badge variant={msg.status === 'In Review' ? 'secondary' : 'default'} className="text-xs">
                          {msg.status}
                        </Badge>
                  ...
                  <div className="space-y-2.5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-700">
                          {msg.deliveryDate ? format(msg.deliveryDate, "PP") : 'Not set'} at {msg.deliveryTime}
                        </p>
                      </div>
                    ...
                    {msg.files.length > 0 && (
                      <div>
                        <Label className="text-xs font-medium text-slate-500 mb-2 block">Files</Label>
